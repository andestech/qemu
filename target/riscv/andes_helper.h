...
DEF_HELPER_5(vln8_v, void, ptr, ptr, tl, env, i32)
DEF_HELPER_5(vln8_v_mask, void, ptr, ptr, tl, env, i32)
DEF_HELPER_5(vlnu8_v, void, ptr, ptr, tl, env, i32)
DEF_HELPER_5(vlnu8_v_mask, void, ptr, ptr, tl, env, i32)
...
DEF_HELPER_2(andes_ace, void, env, tl)
DEF_HELPER_FLAGS_2(andes_v5_hsp_check, TCG_CALL_NO_RWG, void, env, tl)

/* Andes Vector Matrix Multiplication */
DEF_HELPER_5(andes_vqammuu_vv, void, ptr, ptr, ptr, env, i32)
DEF_HELPER_5(andes_vqammus_vv, void, ptr, ptr, ptr, env, i32)
DEF_HELPER_5(andes_vqammsu_vv, void, ptr, ptr, ptr, env, i32)
DEF_HELPER_5(andes_vqammss_vv, void, ptr, ptr, ptr, env, i32)
DEF_HELPER_5(andes_vle8_mk, void, ptr, tl, tl, env, i32)
DEF_HELPER_5(andes_vle8_nk, void, ptr, tl, tl, env, i32)
DEF_HELPER_5(andes_vle8_kn, void, ptr, tl, tl, env, i32)
DEF_HELPER_5(andes_vle32_mn, void, ptr, tl, tl, env, i32)
DEF_HELPER_5(andes_vse8_nk, void, ptr, tl, tl, env, i32)
DEF_HELPER_5(andes_vse8_kn, void, ptr, tl, tl, env, i32)
DEF_HELPER_5(andes_vse32_nm, void, ptr, tl, tl, env, i32)
DEF_HELPER_5(andes_vse32_mn, void, ptr, tl, tl, env, i32)
