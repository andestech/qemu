                                       ...
                                       fp_spec_csr_init_fn spec_csr_init)
{
    ...
    if (!env->misa_ext) {
        riscv_cpu_set_misa_ext(
                env, RVI | RVM | RVA | RVF | RVD | RVC | RVS | RVU | RVX);
    }
...
static void rv64_andes_ax45mpv_cpu_init(Object *obj)
{
    ...
    riscv_cpu_set_misa_ext(
            env, RVI | RVM | RVA | RVF | RVD | RVC | RVS | RVU | RVV | RVX);
    rv64_andes_common_cpu_init(obj, VM_1_10_SV48, andes_set_mmsc_cfg_l2c);
...
static void rv64_andes_nx25_cpu_init(Object *obj)
{
    ...
    riscv_cpu_set_misa_ext(
            env, RVI | RVM | RVA | RVF | RVD | RVC | RVU | RVX);
...
static void rv64_andes_nx27v_cpu_init(Object *obj)
{
    ...
    riscv_cpu_set_misa_ext(
            env, RVI | RVM | RVA | RVF | RVD | RVC | RVU | RVV | RVX);
    rv64_andes_common_cpu_init(obj, VM_1_10_MBARE, NULL);
    cfg->mmu = false;
...
static Property andes_cpu_property[] = {
    ...
    DEFINE_PROP_UINT16("xandesbiuaddrwidth", RISCVCPU, cfg.XAndesBiuAddrWidth,
                       64),
    DEFINE_PROP_END_OF_LIST(),
};
